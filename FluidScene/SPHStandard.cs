    ...
    */
    ...
    class SPHStandard
    {
        ...
        public void Update()
        {
            ...
            if (keyboardState[Key.Y]) kRestDensity += 0.00005f;
            if (keyboardState[Key.H]) kRestDensity -= 0.00005f;
            ...
            if (mouseState[MouseButton.Right])
            {
                ...
                if (v != Vector2.Zero)
                {
                    ...
                    if (distSquared < radius * radius)
                    {
                        ...
                        externalForce += v / distSquared * 5 * kGravity;
                ...
                if (!line.IsDot())
                {
                    ...
                    if (proj > 0.0f && proj < 1.0f)
                    {
                        ...
                        if (distSquared < kCollisionRadius * kCollisionRadius)
                        {
                            ...
                            {
                                Vector2 lineN = line.Vector.PerpendicularLeft.Normalized();
                                p.PositionPredicted += lineN * (kCollisionRadius - (float)Math.Sqrt(distSquared)) * dt;
                            }
                        }
                    }
                }
